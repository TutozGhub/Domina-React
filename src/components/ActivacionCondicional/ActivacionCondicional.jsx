...
export default function ActivacionCondicional() {
      ...
      >
        <div className="mb-3">
          ...
          {showMessage && !validName && (
            <p className="red">El nombre debe tener mas de 3 letras.</p>
          )}
        </div>
        <div className="mb-3">
          ...
          {showMessage && !validMail && (
            <p className="red">Debe utilizar un mail valido.</p>
          )}
        </div>
        <div className="mb-3">
          ...
          {showMessage && !validDirection && (
            <p className="red">La dirección debe tener mas de 3 letras.</p>
          )}
        </div>
        <div className="mb-3">
          <button
            ...
            disabled={
              !validName || !validMail || !validDirection ? true : false
            }
          >
            Enviar
          </button>
